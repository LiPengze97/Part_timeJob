...
class ChuLiTableViewCell: UITableViewCell {
    ...
    override init(style: UITableViewCellStyle, reuseIdentifier: String?) {
        ...
        clickLabel?.textColor = kRGBColorFromHex(rgbValue: 0x282828)
        priceLabel?.textColor = UIColor(red: 49/255.0, green: 197/255.0, blue: 239/255.0, alpha: 1.0)
        travelLabel?.textColor = UIColor(red: 49/255.0, green: 197/255.0, blue: 239/255.0, alpha: 1.0)
