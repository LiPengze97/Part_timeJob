...
class DaiFuKuanTableViewCell: UITableViewCell {
    ...
    var clickLabel:UILabel?
     ...
     override init(style: UITableViewCellStyle, reuseIdentifier: String?) {
        ...
        priceLabel?.textColor = UIColor(red: 242/255.0, green: 110/255.0, blue: 125/255.0, alpha: 1.0)
        travelLabel?.textColor = UIColor(red: 242/255.0, green: 110/255.0, blue: 125/255.0, alpha: 1.0)
